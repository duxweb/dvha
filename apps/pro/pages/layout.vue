...
const { mode, isDark, toggle, cssInit, setColor } = useTheme()
...
<template>
  <n-config-provider :theme="isDark ? darkTheme : lightTheme" :theme-overrides="isDark ? darkThemeOverrides : lightThemeOverrides">
    <n-message-provider>
